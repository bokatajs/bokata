...
describe('NER', () => {
  ...
  describe('Remove rule option texts', () => {
    test('A text can be removed', () => {
      const instance = new Ner({ container });
      instance.addRuleOptionTexts('en', 'A1', 'opt1', ['text1', 'text2', 'text3', 'text4']);
    ...
    test('If no text is defined use the option name', () => {
      const instance = new Ner({ container });
      instance.addRuleOptionTexts('en', 'A1', 'opt1', ['text1', 'text2', 'opt1', 'text4']);
    ...
    test('The locale can be a list', () => {
      const instance = new Ner({ container });
      instance.addRuleOptionTexts(['en', 'es'], 'A1', 'opt1', ['text1', 'text2', 'text3', 'text4']);
  ...
  describe('Get rules', () => {
    test('It can get all the rules of a locale', () => {
      const instance = new Ner({ container });
      instance.addRuleOptionTexts('en', 'A1', 'opt1', ['text1', 'text2', 'text3']);
      instance.addRuleOptionTexts('en', 'A1', 'opt2', ['text4', 'text5', 'text6']);
    ...
    test('It should add the wildcard rules', () => {
      const instance = new Ner({ container });
      instance.addRuleOptionTexts('en', 'A1', 'opt1', ['text1', 'text2', 'text3']);
      instance.addRuleOptionTexts(undefined, 'A1', 'opt2', ['text4', 'text5', 'text6']);
      const actual = instance.getRules('en');
      expect(actual).toEqual([
        {
          name: 'A1',
